...
var $author$project$Main$initialModel = {
	clickMode: $author$project$Main$Open,
	field: $elm$core$Array$empty,
	fieldSize: _Utils_Tuple2(5, 5),
	gameStatus: $author$project$Main$Start,
	numOfMines: 3,
	startPos: _Utils_Tuple2(0, 0),
	viewField: $elm$core$Array$empty
};
...
var $author$project$Main$MakeField = function (a) {
	return {$: 'MakeField', a: a};
};
...
var $author$project$Main$array2Get = F3(
	function (x, y, arr) {
		var _v0 = A2($elm$core$Array$get, y, arr);
		if (_v0.$ === 'Just') {
			var a = _v0.a;
			return A2($elm$core$Array$get, x, a);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Main$array2Set = F4(
...
var $author$project$Main$getCoodList = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$core$List$map,
...
var $author$project$Main$makeField = function (model) {
	var newField = A3(
		...
		F2(
			function (_v2, field) {
				...
				return A4(
					...
					y,
					function () {
						var _v3 = A3($author$project$Main$array2Get, x, y, field);
						if ((_v3.$ === 'Just') && (_v3.a.$ === 'Mine')) {
							var _v4 = _v3.a;
								...
								A3(
									...
									F2(
										function (_v5, n) {
											var x_ = _v5.a;
											var y_ = _v5.b;
											var _v6 = A3($author$project$Main$array2Get, x + x_, y + y_, field);
		...
		$elm$core$List$concat(
			$author$project$Main$getCoodList(model.fieldSize)));
	var newViewField = function () {
		var _v0 = model.startPos;
		var x = _v0.a;
		var y = _v0.b;
		return A4(
			$author$project$Main$array2Set,
			...
			y,
			function () {
				var _v1 = A3($author$project$Main$array2Get, x, y, newField);
				if ((_v1.$ === 'Just') && (_v1.a.$ === 'Space')) {
					var n = _v1.a.a;
					return $author$project$Main$Opened(n);
				} else {
...
var $author$project$Main$putMine = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$random$Random$pair,
		A2($elm$random$Random$int, 0, x - 1),
		A2($elm$random$Random$int, 0, y - 1));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		var debug = A2($elm$core$Debug$log, 'model', model);
		switch (msg.$) {
			case 'Button':
									...
									field: function (_v2) {
										...
										return A2(
											...
											A2(
												$elm$core$Array$repeat,
												x,
												$author$project$Main$Space(0)));
									}(model.fieldSize),
									gameStatus: $author$project$Main$FirstOne,
									viewField: function (_v3) {
										var x = _v3.a;
										var y = _v3.b;
										return A2(
											$elm$core$Array$repeat,
											y,
											A2($elm$core$Array$repeat, x, $author$project$Main$Hidden));
									}(model.fieldSize)
								}),
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									startPos: _Utils_Tuple2(x, y),
									viewField: A4($author$project$Main$array2Set, x, y, $author$project$Main$Hidden, model.viewField)
								}),
							A2(
								$elm$random$Random$generate,
								...
								case 'Hidden':
									...
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												viewField: A4($author$project$Main$array2Set, x, y, $author$project$Main$Flagged, model.viewField)
											}),
										$elm$core$Platform$Cmd$none);
								default:
									break _v9$2;
			...
			case 'Place':
				...
				if (_Utils_eq(
					...
					return _Utils_Tuple2(
						...
						A2(
							$elm$random$Random$generate,
							$author$project$Main$Place(n),
							$author$project$Main$putMine(model.fieldSize)));
				} else {
					var newModel = _Utils_update(
						model,
						{
							field: A4($author$project$Main$array2Set, x, y, $author$project$Main$Mine, model.field)
						});
					return _Utils_eq(n, model.numOfMines) ? _Utils_Tuple2(
						newModel,
						A2(
							$elm$core$Task$perform,
							$author$project$Main$MakeField,
							$elm$core$Task$succeed(_Utils_Tuple0))) : _Utils_Tuple2(
						newModel,
						A2(
							$elm$random$Random$generate,
							$author$project$Main$Place(n + 1),
							$author$project$Main$putMine(model.fieldSize)));
				}
			case 'ToggleMode':
				return _Utils_eq(model.gameStatus, $author$project$Main$Playing) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							clickMode: _Utils_eq(model.clickMode, $author$project$Main$Open) ? $author$project$Main$Flag : $author$project$Main$Open
						}),
...
var $author$project$Main$Button = {$: 'Button'};
var $author$project$Main$Click = function (a) {
	return {$: 'Click', a: a};
};
var $author$project$Main$Height = {$: 'Height'};
var $author$project$Main$NumOfMines = {$: 'NumOfMines'};
var $author$project$Main$TextBox = F2(
	function (a, b) {
		return {$: 'TextBox', a: a, b: b};
	});
...
var $author$project$Main$mode2Str = function (mode) {
	if (mode.$ === 'Open') {
		return 'Open';
	} else {
		return 'Flag';
				...
				function (li) {
					return A2(
						...
						function (_v3) {
							var x = _v3.a;
							var y = _v3.b;
							var _v4 = A3($author$project$Main$array2Get, x, y, model.viewField);
							if (_v4.$ === 'Just') {
								switch (_v4.a.$) {
									case 'Opened':
										var n = _v4.a.a;
											...
											_List_fromArray(
												[
													...
													$author$project$Main$Click(
														_Utils_Tuple2(x, y))),
													A2($elm$html$Html$Attributes$style, 'width', buttonSize),
													A2($elm$html$Html$Attributes$style, 'height', buttonSize)
												]),
											_List_fromArray(
												[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(model.fieldSize.a)),
								$elm$html$Html$Events$onInput(
								$author$project$Main$TextBox($author$project$Main$Width))
							]),
						_List_Nil),
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$min('2'),
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(model.fieldSize.b)),
								$elm$html$Html$Events$onInput(
								$author$project$Main$TextBox($author$project$Main$Height))
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$elm$html$Html$text('number of mines : '),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(model.numOfMines)),
								$elm$html$Html$Events$onInput(
								$author$project$Main$TextBox($author$project$Main$NumOfMines))
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									'ModeChange (Current Mode : ' + ($author$project$Main$mode2Str(model.clickMode) + ' )'))
								]))
						])));
	}
};
